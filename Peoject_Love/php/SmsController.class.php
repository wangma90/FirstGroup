...
class SmsController
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIv0b2qVUMkfMC"; // AccessKeyId

        $accessKeySecret = "LisJgmgG6fhdflYD1ab0W5BqJjD2bI"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers("17610291250");

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("chengxu王1");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_126470009");
